...
export const accommodations: Record<string, Accommodation> = {
  postojna: {
    ...
    wazeUrl: "https://www.google.com/maps/dir/?api=1&destination=45.7784%2C14.2052",
  ...
  rastovaca: {
    ...
    wazeUrl: "https://www.google.com/maps/dir/?api=1&destination=44.8800%2C15.6200",
  ...
  brezice: {
    ...
    wazeUrl: "https://www.google.com/maps/dir/?api=1&destination=45.9042%2C15.5903",
  ...
  bled: {
    ...
    wazeUrl: "https://www.google.com/maps/dir/?api=1&destination=46.3686%2C14.1139",
...
export const days: Day[] = [
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    accommodation: {
      ...
      wazeUrl: "https://www.google.com/maps/dir/?api=1&destination=45.6340%2C12.5618",
    ...
    schedule: [
      ...
      { time: "22:45", desc: "🏨 נסיעה ל-Hotel Forte del 48 (~35 דק')", links: [{ label: "Waze למלון", url: "https://www.google.com/maps/dir/?api=1&destination=45.6340%2C12.5618", type: "map" as const }] },
  ...
  // ═══════════════════════
  {
    ...
    schedule: [
      { time: "07:30", desc: "יציאה — כביש מהיר דרך Trieste", duration: "1:45 שע'", links: [{ label: "ניווט", url: "https://www.google.com/maps/dir/?api=1&destination=45.7039%2C13.7920", type: "map" }] },
      ...
      { time: "13:15", desc: "🚗 נסיעה לטירת פרדיאמה", duration: "25 דק'", links: [{ label: "ניווט", url: "https://www.google.com/maps/dir/?api=1&destination=45.8162%2C14.0004", type: "map" }] },
      ...
      { time: "15:15", desc: "🚗 נסיעה ל-Vila Lemic", duration: "30 דק'", links: [{ label: "Waze ללינה", url: "https://www.google.com/maps/dir/?api=1&destination=45.7784%2C14.2052", type: "map" }] },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "10:45", desc: "🚗 נסיעה דרומה לקרואטיה", duration: "2:15 שע'", links: [{ label: "Waze לראסטוקה", url: "https://www.google.com/maps/dir/?api=1&destination=44.8963%2C15.6244", type: "map" }] },
      ...
      { time: "15:15", desc: "🚗 נסיעה לפליטביצה", duration: "30 דק'", links: [{ label: "Waze ל-Flora House", url: "https://www.google.com/maps/dir/?api=1&destination=44.8800%2C15.6200", type: "map" }] },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "12:45", desc: "הגעה לברז'יצה — ארוחת צהריים (צ'ק-אין רק מ-14:00 — התיקים נשארים ברכב)", links: [{ label: "Waze ללינה", url: "https://www.google.com/maps/dir/?api=1&destination=45.9042%2C15.5903", type: "map" }] },
  ...
  // ═══════════════════════
  {
    ...
    schedule: [
      ...
      { time: "09:45", desc: "🛍️ BTC City Ljubljana — ניאופרן, נעלי מים, ציוד שחייה לסוצ'ה", duration: "1.5–2 שע'", links: [{ label: "BTC City", url: "https://www.btc.si", type: "site" }, { label: "Waze ל-BTC", url: "https://www.google.com/maps/dir/?api=1&destination=46.0897%2C14.5394", type: "map" }] },
      { time: "11:45", desc: "ארוחה ב-BTC", duration: "30 דק'" },
      { time: "12:15", desc: "🚗 נסיעה לבוהין (צ'ק-אין בבלד רק מ-15:00 — קודם אגם!)", duration: "1:15 שע'", links: [{ label: "Waze לבוהין", url: "https://www.google.com/maps/dir/?api=1&destination=46.2833%2C13.8875", type: "map" }] },
      ...
      { time: "16:30", desc: "🚗 נסיעה לבלד, צ'ק-אין Barn House MM (מ-15:00)", duration: "40 דק'", links: [{ label: "Waze לבלד", url: "https://www.google.com/maps/dir/?api=1&destination=46.3686%2C14.1139", type: "map" }] },
  ...
  },
  {
    ...
    schedule: [
      { time: "07:40", desc: "🚗 יציאה לחניון VINTGAR LIP (חינם) — משם שאטל חשמלי כל 7 דק'", duration: "15 דק'", links: [{ label: "Waze לחניון LIP", url: "https://www.google.com/maps/dir/?api=1&destination=46.3974%2C14.0875", type: "map" }] },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "11:30", desc: "🚗 נסיעה ל-Ukanc", duration: "15 דק'", links: [{ label: "Waze לוואגל", url: "https://www.google.com/maps/dir/?api=1&destination=46.2841%2C13.8486", type: "map" }] },
  ...
  // יום 9
  {
    ...
    accommodation: {
      ...
      wazeUrl: "https://www.google.com/maps/dir/?api=1&destination=46.3356%2C13.5526",
    ...
    schedule: [
      { time: "07:50", desc: "יציאה מבלד לתחנת Bohinjska Bistrica", duration: "20–25 דק'", links: [{ label: "Waze לרכבת", url: "https://www.google.com/maps/dir/?api=1&destination=46.2622%2C13.9558", type: "map" }] },
      ...
      { time: "16:00", desc: "צ'ק-אין Charming Bovec (נפתח 16:00) — דרך האפליקציה", links: [{ label: "Waze לדירה", url: "https://www.google.com/maps/dir/?api=1&destination=46.3356%2C13.5526", type: "map" }] },
  ...
  // יום 10
  {
    ...
    schedule: [
      { time: "08:30", desc: "🌊 מפל קוזיאק — להקדים לפני קהל החג! 20 דק' נסיעה + 30 דק' הליכה קלה למפל שבמנהרה", duration: "2 שע'", links: [{ label: "ניווט", url: "https://www.google.com/maps/dir/?api=1&destination=46.2480%2C13.5830", type: "map" }, { label: "מפה", url: "https://www.google.com/maps/search/?api=1&query=Kozjak+waterfall+Kobarid", type: "map" }] },
      { time: "11:00", desc: "📸 Virje (לפנה) בדרך חזרה — תצפית + תמונות (עד שעתיים חניה)", duration: "45 דק'", links: [{ label: "ניווט", url: "https://www.google.com/maps/dir/?api=1&destination=46.3640%2C13.5043", type: "map" }] },
  ...
  // יום 11
  {
    ...
    schedule: [
      ...
      { time: "08:30", desc: "📍 הגעה ל-Sport Mix", links: [{ label: "ניווט", url: "https://www.google.com/maps/dir/?api=1&destination=46.3368%2C13.5536", type: "map" }, { label: "sportmix.si", url: "https://www.sportmix.si", type: "site" }] },
  ...
  // יום 13
  {
    ...
    accommodation: {
      ...
      wazeUrl: "https://www.google.com/maps/dir/?api=1&destination=45.5052%2C12.3519",
    },
    attractions: [],
    alerts: [
    ...
    schedule: [
      { time: "08:30", desc: "יציאה מבווץ — Predel Pass → Tarvisio → A4 → ונציה", duration: "3.5 שע'", links: [{ label: "Waze לפיאצלה רומא", url: "https://www.google.com/maps/dir/?api=1&destination=45.4408%2C12.3202", type: "map" }] },
      ...
      { time: "16:15", desc: "🚗 נסיעה לשדה התעופה מרקו פולו", duration: "20 דק'", links: [{ label: "Waze לשדה", url: "https://www.google.com/maps/dir/?api=1&destination=45.5052%2C12.3519", type: "map" }] },
